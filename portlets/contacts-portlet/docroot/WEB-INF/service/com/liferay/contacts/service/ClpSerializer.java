	...
	public static Object translateInputEntry(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				...
				Method method7 = newModelClass.getMethod("setEntryUserId",
						new Class[] { Long.TYPE });

				Long value7 = new Long(oldCplModel.getEntryUserId());
				...
				Method method9 = newModelClass.getMethod("setFullName",
						new Class[] { String.class });

				String value9 = oldCplModel.getFullName();

				method9.invoke(newModel, value9);

				Method method10 = newModelClass.getMethod("setComments",
						new Class[] { String.class });

				String value10 = oldCplModel.getComments();
	...
	public static Object translateOutputEntry(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				...
				Method method7 = oldModelClass.getMethod("getEntryUserId");

				Long value7 = (Long)method7.invoke(oldModel, (Object[])null);

				newModel.setEntryUserId(value7);
				...
				Method method9 = oldModelClass.getMethod("getFullName");

				String value9 = (String)method9.invoke(oldModel, (Object[])null);

				newModel.setFullName(value9);

				Method method10 = oldModelClass.getMethod("getComments");

				String value10 = (String)method10.invoke(oldModel,
						(Object[])null);

				newModel.setComments(value10);
