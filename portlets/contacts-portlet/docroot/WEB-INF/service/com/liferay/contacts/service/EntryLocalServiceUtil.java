...
public class EntryLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.contacts.model.Entry addEntry(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().addEntry(user, fullName, emailAddress, comments);
	}
	...
	public static java.util.List<java.lang.Object> getUserAndEntries(
		...
		int end) throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getUserAndEntries(companyId, userId, keywords, start, end);
	}

	public static int getUserAndEntriesCount(long companyId, long userId,
		java.lang.String keywords)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getUserAndEntriesCount(companyId, userId, keywords);
	}
	...
	public static com.liferay.contacts.model.Entry updateEntry(long entryId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateEntry(entryId, user, fullName, emailAddress, comments);
	}
