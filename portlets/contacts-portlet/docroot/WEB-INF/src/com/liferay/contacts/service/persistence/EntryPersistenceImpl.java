...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_FETCH_BY_C_U_EA = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, EntryImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByC_U_EA",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_U_EA = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_U_EA",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_U = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, EntryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_U = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, EntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_U",
			new String[] { Long.class.getName(), Long.class.getName() },
			EntryModelImpl.COMPANYID_COLUMN_BITMASK |
			EntryModelImpl.USERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_U = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public void cacheResult(Entry entry) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_C_U_EA,
			new Object[] {
				Long.valueOf(entry.getCompanyId()),
	...
	protected void clearUniqueFindersCache(Entry entry) {
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_C_U_EA,
			new Object[] {
				Long.valueOf(entry.getCompanyId()),
				Long.valueOf(entry.getUserId()),
	...
	public Entry updateImpl(com.liferay.contacts.model.Entry entry,
		...
		if (isNew || !EntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(entryModelImpl.getOriginalCompanyId()),
				...
				args = new Object[] {
						Long.valueOf(entryModelImpl.getCompanyId()),
						Long.valueOf(entryModelImpl.getUserId())
					};
		...
		if (isNew) {
			...
			if ((entryModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_C_U_EA.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(entryModelImpl.getOriginalCompanyId()),
						Long.valueOf(entryModelImpl.getOriginalUserId()),
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_U_EA, args);
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_C_U_EA, args);
	...
	protected Entry toUnwrappedModel(Entry entry) {
		...
		entryImpl.setEntryUserId(entry.getEntryUserId());
	...
	/**
	 * Returns the entry where companyId = &#63; and userId = &#63; and emailAddress = &#63; or throws a {@link com.liferay.contacts.NoSuchEntryException} if it could not be found.
	 *
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry findByC_U_EA(long companyId, long userId, String emailAddress)
		throws NoSuchEntryException, SystemException {
		Entry entry = fetchByC_U_EA(companyId, userId, emailAddress);
	...
	/**
	 * Returns the entry where companyId = &#63; and userId = &#63; and emailAddress = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param emailAddress the email address
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry fetchByC_U_EA(long companyId, long userId, String emailAddress)
		throws SystemException {
		return fetchByC_U_EA(companyId, userId, emailAddress, true);
	}

	/**
	 * Returns the entry where companyId = &#63; and userId = &#63; and emailAddress = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param emailAddress the email address
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry fetchByC_U_EA(long companyId, long userId,
		String emailAddress, boolean retrieveFromCache)
		throws SystemException {
		Object[] finderArgs = new Object[] { companyId, userId, emailAddress };

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_C_U_EA,
					finderArgs, this);
		}
		...
		if (result instanceof Entry) {
			...
			if ((companyId != entry.getCompanyId()) ||
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_U_EA_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_U_EA_USERID_2);

			if (emailAddress == null) {
				query.append(_FINDER_COLUMN_C_U_EA_EMAILADDRESS_1);
			}
			else {
				if (emailAddress.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_U_EA_EMAILADDRESS_3);
				}
				else {
					query.append(_FINDER_COLUMN_C_U_EA_EMAILADDRESS_2);
				}
			}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((entry.getCompanyId() != companyId) ||
	...
	/**
	 * Returns all the entries where companyId = &#63; and userId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Entry> findByC_U(long companyId, long userId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the entries where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Entry> findByC_U(long companyId, long userId, int start, int end)
		throws SystemException {
		return findByC_U(companyId, userId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the entries where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Entry> findByC_U(long companyId, long userId, int start,
	...
	/**
	 * Returns the first entry in the ordered set where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry findByC_U_First(long companyId, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		List<Entry> list = findByC_U(companyId, userId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last entry in the ordered set where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry findByC_U_Last(long companyId, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		int count = countByC_U(companyId, userId);

		List<Entry> list = findByC_U(companyId, userId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the entries before and after the current entry in the ordered set where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry[] findByC_U_PrevAndNext(long entryId, long companyId,
		...
		try {
			...
			array[0] = getByC_U_PrevAndNext(session, entry, companyId, userId,
					orderByComparator, true);

			array[1] = entry;

			array[2] = getByC_U_PrevAndNext(session, entry, companyId, userId,
	...
	protected Entry getByC_U_PrevAndNext(Session session, Entry entry,
	...
	/**
	 * Removes the entry where companyId = &#63; and userId = &#63; and emailAddress = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param emailAddress the email address
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry removeByC_U_EA(long companyId, long userId, String emailAddress)
		throws NoSuchEntryException, SystemException {
		Entry entry = findByC_U_EA(companyId, userId, emailAddress);

		return remove(entry);
	}

	/**
	 * Removes all the entries where companyId = &#63; and userId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @throws SystemException if a system exception occurred
	...
	public void removeByC_U(long companyId, long userId)
		throws SystemException {
		for (Entry entry : findByC_U(companyId, userId)) {
			remove(entry);
		}
	}
	...
	/**
	 * Returns the number of entries where companyId = &#63; and userId = &#63; and emailAddress = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param emailAddress the email address
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByC_U_EA(long companyId, long userId, String emailAddress)
		throws SystemException {
		Object[] finderArgs = new Object[] { companyId, userId, emailAddress };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_C_U_EA,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_U_EA,
					finderArgs, count);
	...
	/**
	 * Returns the number of entries where companyId = &#63; and userId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @return the number of matching entries
	...
	private static final String _FINDER_COLUMN_C_U_EA_COMPANYID_2 = "entry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_U_EA_USERID_2 = "entry.userId = ? AND ";
	private static final String _FINDER_COLUMN_C_U_EA_EMAILADDRESS_1 = "entry.emailAddress IS NULL";
	private static final String _FINDER_COLUMN_C_U_EA_EMAILADDRESS_2 = "entry.emailAddress = ?";
	private static final String _FINDER_COLUMN_C_U_EA_EMAILADDRESS_3 = "(entry.emailAddress IS NULL OR entry.emailAddress = ?)";
	private static final String _FINDER_COLUMN_C_U_COMPANYID_2 = "entry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_U_USERID_2 = "entry.userId = ?";
