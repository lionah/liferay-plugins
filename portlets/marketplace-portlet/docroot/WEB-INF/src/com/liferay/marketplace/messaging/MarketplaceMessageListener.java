...
public class MarketplaceMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		String[] bundleSymbolicNames = StringUtil.split(
		...
		for (String bundleSymbolicName : bundleSymbolicNames) {
			...
			if (bundleSymbolicName.contains(StringPool.POUND)) {
				String[] bundleSymbolicNameParts = StringUtil.split(
					bundleSymbolicName, StringPool.POUND);

				bundleSymbolicName = bundleSymbolicNameParts[0];
				bundleVersion = bundleSymbolicNameParts[1];
				contextName = bundleSymbolicNameParts[2];
			}
