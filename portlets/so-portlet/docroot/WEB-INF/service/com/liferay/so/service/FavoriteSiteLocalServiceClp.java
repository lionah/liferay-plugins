...
public class FavoriteSiteLocalServiceClp implements FavoriteSiteLocalService {
	public FavoriteSiteLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_createFavoriteSiteMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createFavoriteSite",
				com.liferay.so.service.persistence.FavoriteSitePK.class);
	...
	public com.liferay.so.model.FavoriteSite createFavoriteSite(
		com.liferay.so.service.persistence.FavoriteSitePK favoriteSitePK) {
		Object returnObj = null;

		MethodHandler methodHandler = new MethodHandler(_createFavoriteSiteMethodKey1,
				ClpSerializer.translateInput(favoriteSitePK));
	...
	public java.util.List<com.liferay.so.model.FavoriteSite> getUserFavoriteSites(
		long userId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		Object returnObj = null;

		MethodHandler methodHandler = new MethodHandler(_getUserFavoriteSitesMethodKey19,
				userId, start, end);
	...
	public int getUserFavoriteSitesCountByName(long companyId, long userId,
		...
		MethodHandler methodHandler = new MethodHandler(_getUserFavoriteSitesCountByNameMethodKey22,
				companyId, userId, ClpSerializer.translateInput(name));
