...
create index IX_8E78C4 on SO_FavoriteSite (userId, groupId);

create index IX_195B8725 on SO_FavoriteSitesEntry (userId);
create index IX_E8CF2725 on SO_FavoriteSitesEntry (userId, groupId);
