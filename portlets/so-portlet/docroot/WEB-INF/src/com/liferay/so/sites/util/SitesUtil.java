...
public class SitesUtil {
	...
	public static List<Group> getFavoriteSites(
			long companyId, long userId, String name, int maxResultSize)
		throws Exception {
		...
		List<FavoriteSite> favoriteSites =
			FavoriteSiteLocalServiceUtil.getUserFavoriteSitesByName(
				companyId, userId, name, start, maxResultSize);

		List<Group> groups = new ArrayList<Group>(favoriteSites.size());

		for (FavoriteSite favoriteSite : favoriteSites) {
			try {
				groups.add(GroupServiceUtil.getGroup(
					favoriteSite.getGroupId()));
			}
			catch (Exception e) {
				FavoriteSiteLocalServiceUtil.deleteFavoriteSite(
					favoriteSite.getPrimaryKey());
			}
		}
	...
	public static int getFavoriteSitesCount(
		...
		return
			FavoriteSiteLocalServiceUtil.getUserFavoriteSitesCountByName(
