 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.so.model.FavoriteSiteModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FavoriteSiteImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see FavoriteSiteImpl
 * @see com.liferay.so.model.FavoriteSite
 * @see com.liferay.so.model.FavoriteSiteModel
 * @generated
 */
public class FavoriteSiteModelImpl extends BaseModelImpl<FavoriteSite>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a favorite site model instance should use the {@link com.liferay.so.model.FavoriteSite} interface instead.
	 */
	...
	public static final String TABLE_SQL_CREATE = "create table SO_FavoriteSite (userId LONG not null,groupId LONG not null,companyId LONG,primary key (userId, groupId))";
