...
public class FavoriteSitePersistenceImpl extends BasePersistenceImpl<FavoriteSite>
	...
	public FavoriteSite findByPrimaryKey(Serializable primaryKey)
		...
		return findByPrimaryKey((FavoriteSitePK)primaryKey);
	}
	...
	public FavoriteSite findByPrimaryKey(FavoriteSitePK favoriteSitePK)
		throws NoSuchFavoriteSiteException, SystemException {
		FavoriteSite favoriteSite = fetchByPrimaryKey(favoriteSitePK);

		if (favoriteSite == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + favoriteSitePK);
			}
	...
	public FavoriteSite fetchByPrimaryKey(Serializable primaryKey)
		throws SystemException {
		return fetchByPrimaryKey((FavoriteSitePK)primaryKey);
	}
	...
	public FavoriteSite fetchByPrimaryKey(FavoriteSitePK favoriteSitePK)
		...
		FavoriteSite favoriteSite = (FavoriteSite)EntityCacheUtil.getResult(FavoriteSiteModelImpl.ENTITY_CACHE_ENABLED,
				FavoriteSiteImpl.class, favoriteSitePK);
