...
if (tabs1.equals("my-sites")) {
	groups = SitesUtil.getFavoriteSites(themeDisplay.getCompanyId(), themeDisplay.getUserId(), searchName, maxResultSize);
	groupsCount = SitesUtil.getFavoriteSitesCount(themeDisplay.getCompanyId(), themeDisplay.getUserId(), searchName);
